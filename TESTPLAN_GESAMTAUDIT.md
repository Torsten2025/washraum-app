...
| RP-25 | Releasegrenze | Sichtbar `0.3.0-test.18`; Fixture und Produktfunktion getrennt belegt; keine Produktionswirkung | `test:safety`, `npm run check` |
...
| FA-10 | Gemeinsame Version | Fixture und Restplatz verwenden exakt `0.3.0-test.18` | `test:safety` |
