...
| RP-25 | Releasegrenze | Sichtbar `0.3.12`; Fixture und Produktfunktion getrennt belegt; produktive Aktivierung nur mit eigenem Freigabeschalter | `test:safety`, `npm run check` |
...
| FA-10 | Gemeinsame Version | Fixture und Restplatz verwenden exakt `0.3.12` | `test:safety` |
...
| ID | Pruefung | Soll-Ergebnis | Automatisierung |
| --- | --- | --- | --- |
| NOT-01 | Lokales SMTP | Wohnungseinladung, Bestaetigung, Reset, Admin-Reset und Freigabe-Mail werden zugestellt; ein strenger SMTP-Server weist fuer die lange zweisprachige Einladung ausschliesslich CRLF-Zeilen und hoechstens 998 Bytes pro Datenzeile nach | `npm test` |
