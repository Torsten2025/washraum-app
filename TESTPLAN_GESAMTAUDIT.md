...
| RP-25 | Releasegrenze | Sichtbar `0.3.13`; Fixture und Produktfunktion getrennt belegt; produktive Aktivierung nur mit eigenem Freigabeschalter | `test:safety`, `npm run check` |
...
| FA-10 | Gemeinsame Version | Fixture und Restplatz verwenden exakt `0.3.13` | `test:safety` |
