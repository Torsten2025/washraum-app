...
assert.match(indexHtml, /aria-label="Kalendergr&ouml;&szlig;e"/, 'Kalenderzoom ohne Gruppenbeschriftung');
assert.match(indexHtml, /id="calendarZoomOutButton"[^>]*aria-label="Kalender verkleinern"/, 'Zoom-out ohne Beschriftung');
assert.match(indexHtml, /id="calendarZoomInButton"[^>]*aria-label="Kalender vergr&ouml;&szlig;ern"/, 'Zoom-in ohne Beschriftung');
