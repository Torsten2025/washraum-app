...
async function run() {
  ...
  try {
    ...
    assert.equal(versionStatus.body.version, '0.3.0');
    ...
    assert.ok(indexHtml.includes('/intro-media.js?v=v0.3.0'));
    assert.ok(indexHtml.includes('/assets/intro/media/resident-de.mp4'));
    assert.ok(indexHtml.includes('Kapitel 1 von 9'));
    assert.ok(indexHtml.includes('name="waschzeit-version" content="0.3.0"'));
    ...
    assert.ok(indexHtml.includes('/app.js?v=v0.3.0'));
    assert.ok(indexHtml.includes('/styles.css?v=v0.3.0'));
