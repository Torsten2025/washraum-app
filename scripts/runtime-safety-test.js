...
function verifyBlueprintsAndVersion() {
  ...
  assert.equal(packageInfo.version, '0.3.13');
  ...
  assert.ok(serviceWorker.includes("const CACHE_NAME = 'waschzeit-pwa-v0.3.13';"));
  ...
  assert.match(agentTest, /APP_RELEASE[\s\S]*value: agent-v0\.3\.10/);
