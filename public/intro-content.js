  ...
  const residentDe = introduction(
    ...
    [
      ...
      },
      {
        ...
        transcript: 'Wenn eine Maschine oder ein Raum nicht richtig funktioniert, erstellst du eine sachliche Stoerungsmeldung. Dein Text bleibt als persoenliche Meldung getrennt und kann von dir geloescht werden. Statushinweise per Push oder E-Mail sind freiwillig und anfangs ausgeschaltet. Die drei sichtbaren Status sind Neu, In Bearbeitung und Erledigt.',
  ...
  const residentEn = introduction(
    ...
    [
      ...
      },
      {
        ...
        transcript: 'If a machine or room does not work correctly, create a factual issue report. Your text remains a separate personal report that you can delete. Push and email status updates are optional and initially switched off. The three visible statuses are New, In progress and Done.',
        scene: 'resident-report-issue',
        visual: { kind: 'app', view: 'issue-report', focus: 'resource-and-description' }
      },
      {
  ...
  const houseAdminDe = introduction(
    ...
    [
      ...
      },
      {
        ...
        startTime: 106,
        duration: 26,
        caption: 'Wechsle zu Geraete und fuehre Waschmaschinen, Tumbler und Trockenraeume eindeutig.',
        transcript: 'Unter Haus und Geraete wechselst du zuerst bewusst zwischen Hausdaten und Geraetebestand. Als Haus-Admin startest du direkt bei den Geraeten deines eigenen Hauses. Verwende eindeutige Namen, damit Kalender, Meldung und Tagebuch dieselbe Ressource meinen. Gesperrte Ressourcen werden nur ueber den Tagebuchablauf wieder freigegeben.',
      ...
      },
      {
        ...
        startTime: 132,
        duration: 28,
        caption: 'Arbeite mit Neu, In Bearbeitung und Erledigt; technische Schritte bleiben in der Chronik.',
        transcript: 'Das Tagebuch zeigt nur die drei Hauptstatus Neu, In Bearbeitung und Erledigt. Persoenliche Meldungstexte bleiben getrennt und loeschbar. Im neutralen Betriebsnachweis dokumentierst du nur Ressource, Zeiten und sachliche Massnahmen. Bestehende technische Eintraege werden nicht geloescht oder nachtraeglich veraendert.',
      ...
      },
      {
        ...
        description: 'Wiederkehrende Waschpakete atomar und nachvollziehbar verwalten.',
        startTime: 190,
        duration: 26,
        caption: 'Ein Dauerpaket enthaelt eine Waschmaschine und optional Trockenraum oder Tumbler.',
        transcript: 'Ein Dauerpaket enthaelt genau eine Waschmaschine. Optional fuegst du einen Trockenraum mit passender Nutzungsdauer und einen Tumbler hinzu. Alle Bestandteile werden gemeinsam geprueft und gespeichert. Bei einem Konflikt entsteht kein Teilpaket; entfernt wird spaeter immer das vollstaendige kuenftige Paket.',
  ...
  const houseAdminEn = introduction(
    ...
    [
      ...
      },
      {
        ...
        startTime: 106,
        duration: 26,
        caption: 'Switch to Equipment and maintain washing machines, tumblers and drying rooms clearly.',
        transcript: 'In House and Equipment, first switch deliberately between house details and the equipment inventory. As a house administrator, you start directly with equipment from your own house. Use clear names so the calendar, report and logbook refer to the same resource. Blocked resources can only be released through the logbook workflow.',
        scene: 'house-admin-equipment-management',
        visual: { kind: 'app', view: 'admin-equipment', focus: 'resource-list' }
      },
      {
        ...
        startTime: 132,
        duration: 28,
        caption: 'Use New, In progress and Done; technical steps remain in the timeline.',
        transcript: 'The logbook shows only the three main statuses New, In progress and Done. Personal report text stays separate and deletable. The neutral operational record contains only the resource, times and factual measures. Existing technical entries cannot be deleted or changed afterwards.',
        scene: 'house-admin-machine-room-logbook',
        visual: { kind: 'app', view: 'equipment-logbook', focus: 'history' }
      },
      {
      ...
      },
      {
        ...
        description: 'Manage recurring laundry packages atomically and predictably.',
        startTime: 190,
        duration: 26,
        caption: 'A recurring package contains one washer and optionally a drying room or tumbler.',
        transcript: 'A recurring package contains exactly one washing machine. You may add one drying room with a suitable duration and one tumbler. Every component is checked and saved together. A conflict creates no partial package, and removal always covers the complete future package.',
        scene: 'house-admin-recurring-appointments',
        visual: { kind: 'app', view: 'admin-recurring', focus: 'schedule-and-validity' }
      },
      {
  ...
  const superadminDe = introduction(
    ...
    [
      ...
      },
      {
        ...
        startTime: 52,
        duration: 28,
        caption: 'Nutze Haus fuer Standorte und Geraete nur fuer den Bestand des aktiven Hauses.',
        transcript: 'Unter Haus und Geraete startest du als Superadmin bei der Hausauswahl. Der Reiter Haus zeigt Standorte und Stammdaten; der Reiter Geraete zeigt ausschliesslich Ressourcen des serverseitig aktiven Hauses. Vor einer Deaktivierung pruefst du aktive Bewohner, Buchungen, offene Vorgaenge und die notwendige Datensicherung.',
  ...
  const superadminEn = introduction(
    ...
    [
      ...
      },
      {
        ...
        startTime: 52,
        duration: 28,
        caption: 'Use House for locations and Equipment only for the active house inventory.',
        transcript: 'In House and Equipment, super administrators start with house selection. The House tab contains locations and master data; Equipment shows only resources from the server-side active house. Before deactivation, review active residents, bookings, open workflows and the required data backup.',
        scene: 'superadmin-house-lifecycle',
        visual: { kind: 'app', view: 'superadmin-houses', focus: 'create-edit-deactivate' }
      },
      {
