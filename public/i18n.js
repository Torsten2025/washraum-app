(function initWaschZeitI18n(global) {
  ...
  const messages = {
    ...
    'common.loggingOut': { de: 'Wird abgemeldet...', en: 'Signing out...' },
    ...
    'auth.logoutFailed': { de: 'Abmelden konnte nicht abgeschlossen werden.', en: 'Sign out could not be completed.' },
    ...
    'onboarding.eyebrow': { de: 'Bestehendes Konto', en: 'Existing account' },
    'onboarding.title': { de: 'Dieses alte Konto braucht eine Wohnung.', en: 'This existing account needs an apartment.' },
    'onboarding.description': { de: 'Bitte die Hausverwaltung um eine Einladung an deine persoenliche E-Mail-Adresse. Nach der Bestaetigung bleibt dein Login bestehen und wird sicher der richtigen Wohnung zugeordnet.', en: 'Ask the building administration to send an invitation to your personal email address. After confirmation, your login remains active and is securely assigned to the correct apartment.' },
    'onboarding.useInvitation': { de: 'Persoenliche Einladung verwenden', en: 'Use a personal invitation' },
    'onboarding.invitationHelp': { de: 'Melde dich ab und oeffne den Einladungslink aus deiner E-Mail. Ein Partner-QR ist nur fuer eine weitere Person derselben Wohnung vorgesehen.', en: 'Sign out and open the invitation link from your email. A partner QR code is only intended for another person in the same apartment.' },
    'onboarding.close': { de: 'Wohnungszuordnung spaeter fortsetzen', en: 'Continue apartment assignment later' },
    'onboarding.postpone': { de: 'Spaeter zuordnen', en: 'Assign later' },
    'onboarding.postponed': { de: 'Vor der naechsten Buchung muss das Konto noch einer Wohnung zugeordnet werden.', en: 'The account must be assigned to an apartment before the next booking.' },
    ...
    'remainingSlot.eyebrow': { de: 'Nur heute', en: 'Today only' },
    'remainingSlot.title': { de: 'Restplatz buchen', en: 'Book a remaining slot' },
    'remainingSlot.open': { de: 'Restplätze prüfen', en: 'Check remaining slots' },
    'remainingSlot.refresh': { de: 'Neu prüfen', en: 'Check again' },
    'remainingSlot.requiredText': { de: 'Restplatz für eine kleine Wäsche. Es ist kein Trockenraum enthalten. Ohne Tumblerbuchung muss die Trocknung selbst organisiert werden.', en: 'Remaining slot for a small load of laundry. No drying room is included. If you do not book a tumble dryer, you must arrange drying yourself.' },
    'remainingSlot.slot': { de: 'Waschslot heute', en: 'Laundry slot today' },
    'remainingSlot.washer': { de: 'Waschmaschine', en: 'Washing machine' },
    'remainingSlot.drying': { de: 'Trocknung', en: 'Drying' },
    'remainingSlot.withTumbler': { de: 'Tumbler im selben Slot buchen', en: 'Book a tumble dryer in the same slot' },
    'remainingSlot.tumbler': { de: 'Tumbler', en: 'Tumble dryer' },
    'remainingSlot.chooseTumbler': { de: 'Tumbler auswählen', en: 'Choose a tumble dryer' },
    'remainingSlot.selfDrying': { de: 'Ich organisiere die Trocknung selbst.', en: 'I will arrange drying myself.' },
    'remainingSlot.selfDryingShort': { de: 'Selbst organisiert', en: 'Self-arranged' },
    'remainingSlot.chooseDrying': { de: 'Noch auswählen', en: 'Choose an option' },
    'remainingSlot.review': { de: 'Zusammenfassung', en: 'Summary' },
    'remainingSlot.none': { de: 'Nicht enthalten', en: 'Not included' },
    'remainingSlot.book': { de: 'Restplatz verbindlich buchen', en: 'Confirm remaining slot booking' },
    'remainingSlot.loading': { de: 'Heutige Restplätze werden geprüft...', en: 'Checking today\'s remaining slots...' },
    'remainingSlot.ready': { de: 'Wähle einen Waschslot und danach die Trocknung.', en: 'Choose a laundry slot and then a drying option.' },
    'remainingSlot.alreadyUsed': { de: 'Deine Wohnung hat heute bereits einen Waschslot.', en: 'Your apartment already has a laundry slot today.' },
    'remainingSlot.empty': { de: 'Heute ist kein künftiger Restplatz verfügbar.', en: 'No future remaining slot is available today.' },
    'remainingSlot.dayChanged': { de: 'Der Schweizer Kalendertag hat gewechselt. Bitte neu prüfen.', en: 'The Swiss calendar day has changed. Check again.' },
    'remainingSlot.booked': { de: 'Der Restplatz wurde verbindlich gebucht.', en: 'The remaining slot has been booked.' },
    'remainingSlot.bookingType': { de: 'Restplatz', en: 'Remaining slot' },
    'remainingSlot.removeTumbler': { de: 'Tumbler entfernen', en: 'Remove tumble dryer' },
    'remainingSlot.removeTumblerConfirm': { de: 'Tumbler entfernen und die Trocknung selbst organisieren?', en: 'Remove the tumble dryer and arrange drying yourself?' },
    'remainingSlot.tumblerRemoved': { de: 'Der Tumbler wurde entfernt. Die Trocknung organisierst du selbst.', en: 'The tumble dryer was removed. You will arrange drying yourself.' },
    'remainingSlot.cancel': { de: 'Restplatz stornieren', en: 'Cancel remaining slot' },
    'remainingSlot.cancelConfirm': { de: 'Restplatzpaket vor Beginn vollständig stornieren?', en: 'Cancel the entire remaining slot package before it starts?' },
    'remainingSlot.cancelled': { de: 'Das Restplatzpaket wurde storniert.', en: 'The remaining slot package was cancelled.' },
    'remainingSlot.partyUnavailable': { de: 'Restplätze sind nur für eine aktive Wohnung im aktuellen Haus verfügbar.', en: 'Remaining slots are available only to an active apartment in the current building.' },
    'remainingSlot.started': { de: 'Dieser Restplatz kann nicht mehr abgeschlossen werden.', en: 'This remaining slot can no longer be completed.' },
    'remainingSlot.washerRequired': { de: 'Bitte genau eine Waschmaschine wählen.', en: 'Choose exactly one washing machine.' },
    'remainingSlot.washerUnavailable': { de: 'Die Waschmaschine ist nicht verfügbar.', en: 'The washing machine is unavailable.' },
    'remainingSlot.washerConflict': { de: 'Die Waschmaschine wurde inzwischen gebucht.', en: 'The washing machine has since been booked.' },
    'remainingSlot.tumblerUnavailable': { de: 'Der Tumbler ist nicht verfügbar.', en: 'The tumble dryer is unavailable.' },
    'remainingSlot.tumblerConflict': { de: 'Der Tumbler wurde inzwischen gebucht.', en: 'The tumble dryer has since been booked.' },
    'remainingSlot.tumblerInvalid': { de: 'Bitte höchstens einen gültigen Tumbler wählen.', en: 'Choose no more than one valid tumble dryer.' },
    'remainingSlot.tumblerReserve': { de: 'Mindestens ein Tumbler muss frei bleiben.', en: 'At least one tumble dryer must remain available.' },
    'remainingSlot.dryingChoiceInvalid': { de: 'Bitte genau eine Trocknungsart wählen.', en: 'Choose exactly one drying option.' },
    'remainingSlot.selfDryingRequired': { de: 'Bitte bestätigen, dass du die Trocknung selbst organisierst.', en: 'Confirm that you will arrange drying yourself.' },
    'remainingSlot.requestInvalid': { de: 'Die Buchungsanfrage ist ungültig. Bitte neu prüfen.', en: 'The booking request is invalid. Check again.' },
    'remainingSlot.requestConflict': { de: 'Die Angaben haben sich geändert. Bitte neu prüfen.', en: 'The details have changed. Check again.' },
    'remainingSlot.requestFinal': { de: 'Diese Buchungsanfrage ist nicht mehr aktiv. Bitte neu prüfen.', en: 'This booking request is no longer active. Check again.' },
    'remainingSlot.notFound': { de: 'Restplatz nicht gefunden.', en: 'Remaining slot not found.' },
    'remainingSlot.tumblerNotBooked': { de: 'Dieses Restplatzpaket enthält keinen Tumbler.', en: 'This remaining slot package has no tumble dryer.' },
    'remainingSlot.extensionForbidden': { de: 'Ein Restplatz kann nicht über den normalen Buchungsweg erweitert werden.', en: 'A remaining slot cannot be extended through the regular booking flow.' },
    ...
    'app.houseRuleGbmzNotice': { de: 'Hausregelmodus GBMZ-Regeln', en: 'Building rule mode: GBMZ rules' },
    'app.houseRuleLiberalNotice': { de: 'Hausregelmodus Liberal: Die GBMZ-Zusatzgrenzen gelten nicht; Konflikt-, Rollen-, Haus- und Wartungsschutz bleiben aktiv.', en: 'Building rule mode: Liberal. GBMZ-specific limits do not apply; conflict, role, building and maintenance safeguards remain active.' },
    ...
    'app.noResourcesTitle': { de: 'In diesem Haus sind noch keine Geraete eingerichtet.', en: 'No equipment has been configured for this building yet.' },
    'app.noResourcesHint': { de: 'Sobald ein Haus-Admin Ressourcen anlegt, erscheint hier der Belegungsplan.', en: 'The occupancy schedule will appear here once a building admin adds resources.' },
    ...
    'settings.calendarFeedTitle': { de: 'Persoenlicher Kalenderfeed', en: 'Personal calendar feed' },
    'settings.calendarFeedHint': { de: 'Abonniere deine eigenen und gemeinsam gebuchten Wohnungstermine. Die geheime Adresse darf nicht weitergegeben werden und aktualisiert sich automatisch.', en: 'Subscribe to your own and shared apartment bookings. Keep the secret address private; subscriptions update automatically.' },
    'settings.calendarFeedStepCreate': { de: 'Geheime Abo-Adresse erstellen.', en: 'Create the secret subscription address.' },
    'settings.calendarFeedStepCopy': { de: 'Adresse kopieren oder direkt in der Kalender-App oeffnen.', en: 'Copy the address or open it directly in your calendar app.' },
    'settings.calendarFeedStepSubscribe': { de: 'In deinem Kalender "Kalender abonnieren" beziehungsweise "Per URL hinzufuegen" waehlen und die Adresse einfuegen.', en: 'In your calendar, choose "Subscribe to calendar" or "Add by URL" and paste the address.' },
    'settings.calendarFeedUrl': { de: 'Geheime Kalenderadresse', en: 'Secret calendar address' },
    'settings.calendarFeedCreate': { de: 'Adresse erstellen oder ersetzen', en: 'Create or replace address' },
    'settings.calendarFeedCopy': { de: 'Adresse kopieren', en: 'Copy address' },
    'settings.calendarFeedOpen': { de: 'In Kalender-App oeffnen', en: 'Open in calendar app' },
    'settings.calendarFeedRevoke': { de: 'Adresse widerrufen', en: 'Revoke address' },
    'settings.calendarFeedActive': { de: 'Eine abonnierbare Adresse ist aktiv.', en: 'A subscribable address is active.' },
    'settings.calendarFeedInactive': { de: 'Noch keine abonnierbare Adresse aktiv.', en: 'No subscribable address is active yet.' },
    ...
    'whatsNew.title': { de: 'Neu in Version 0.3.13', en: 'New in version 0.3.13' },
    ...
    'admin.integrationDisabled': { de: 'Deaktiviert', en: 'Disabled' },
    'admin.readyStatus': { de: 'bereit', en: 'ready' },
    'admin.emailLabel': { de: 'E-Mail', en: 'Email' },
    'admin.pushLabel': { de: 'Push', en: 'Push' },
    ...
    'admin.houseRuleMode': { de: 'Hausregelmodus', en: 'Building rule mode' },
    'admin.houseRuleModeFor': { de: 'Hausregelmodus fuer {name}', en: 'Building rule mode for {name}' },
    'admin.houseRuleGbmz': { de: 'GBMZ-Regeln', en: 'GBMZ rules' },
    'admin.houseRuleLiberal': { de: 'Liberal', en: 'Liberal' },
    'weekday.sunday': { de: 'Sonntag', en: 'Sunday' },
    ...
    'admin.addBuildingHint': { de: 'Erzeugt einen leeren Standort; Ressourcen werden separat angelegt', en: 'Creates an empty location; equipment is added separately' },
    ...
    'admin.backupDisabledHint': { de: 'Backups sind in dieser Umgebung deaktiviert. Erstellen und Herunterladen sind nicht verfuegbar.', en: 'Backups are disabled in this environment. Creating and downloading backups are unavailable.' },
    'admin.backupDisabledTitle': { de: 'Backup ist in dieser Umgebung nicht verfuegbar', en: 'Backup is unavailable in this environment' },
    'admin.backupNow': { de: 'Jetzt sichern', en: 'Back up now' },
    'admin.download': { de: 'Herunterladen', en: 'Download' },
    'admin.backupDownloadReady': { de: 'Backup wurde heruntergeladen.', en: 'The backup was downloaded.' },
    ...
    'admin.maintenanceBackupDisabled': { de: 'Nicht verfuegbar, solange Backups in dieser Umgebung deaktiviert sind.', en: 'Unavailable while backups are disabled in this environment.' },
    'admin.maintenanceBackupDisabledTitle': { de: 'Wartungsmodus benoetigt ein aktiviertes Backup', en: 'Maintenance mode requires backups to be enabled' },
    ...
    'admin.emailDisabledHint': { de: 'E-Mail ist in dieser Umgebung deaktiviert. Testmails sind nicht verfuegbar.', en: 'Email is disabled in this environment. Test emails are unavailable.' },
    'admin.emailDisabledTitle': { de: 'E-Mail ist in dieser Umgebung nicht verfuegbar', en: 'Email is unavailable in this environment' },
    ...
    'admin.pushDisabledHint': { de: 'Push ist in dieser Umgebung deaktiviert. Testnachrichten sind nicht verfuegbar.', en: 'Push is disabled in this environment. Test notifications are unavailable.' },
    'admin.pushDisabledTitle': { de: 'Push ist in dieser Umgebung nicht verfuegbar', en: 'Push is unavailable in this environment' },
    ...
    'audit.houseBookingRuleMode': { de: 'Hausregeln geaendert', en: 'Building booking rules changed' },
    'audit.calendarFeedRotate': { de: 'Kalenderadresse erstellt oder ersetzt', en: 'Calendar address created or replaced' },
    'audit.calendarFeedRevoke': { de: 'Kalenderadresse widerrufen', en: 'Calendar address revoked' },
    ...
    'admin.errorBackupDisabled': { de: 'Backups sind in dieser Umgebung deaktiviert.', en: 'Backups are disabled in this environment.' },
    'admin.errorEmailDisabled': { de: 'E-Mail ist in dieser Umgebung deaktiviert.', en: 'Email is disabled in this environment.' },
    'admin.errorPushDisabled': { de: 'Push-Benachrichtigungen sind in dieser Umgebung deaktiviert.', en: 'Push notifications are disabled in this environment.' },
    ...
    'game.practiceBriefOne': { de: 'Trainingsrunde abgeschlossen. Der Lauf wurde nicht in die Tageswertung eingetragen.', en: 'Practice round complete. This run was not added to the daily ranking.' },
    'game.practiceBriefTwo': { de: 'Uebung beendet. Die Sicherungskette ist stabil und die Tageswertung bleibt unveraendert.', en: 'Practice complete. The safety chain is stable and the daily ranking is unchanged.' },
    'game.practiceBriefThree': { de: 'Sauber trainiert. Diese Runde zaehlt nur fuer deine Uebung.', en: 'Good practice. This round only counts as training.' },
    'game.practiceBriefFour': { de: 'Probe erfolgreich. Dein Tagesrang wird durch diese Runde nicht veraendert.', en: 'Trial successful. This round does not change your daily rank.' },
    'game.practiceResultOne': { de: 'Training geschafft in {seconds} Sekunden.', en: 'Practice completed in {seconds} seconds.' },
    'game.practiceResultTwo': { de: 'Uebungsmission in {seconds} Sekunden gesichert.', en: 'Practice mission secured in {seconds} seconds.' },
    'game.practiceResultThree': { de: 'Sicherungstraining nach {seconds} Sekunden beendet.', en: 'Safety practice completed after {seconds} seconds.' },
    'game.practiceResultFour': { de: 'Probelauf in {seconds} Sekunden abgeschlossen.', en: 'Trial run completed in {seconds} seconds.' },
    'maintenance.statusNew': { de: 'Neu', en: 'New' },
    'maintenance.statusInProgress': { de: 'In Bearbeitung', en: 'In progress' },
    'maintenance.statusDone': { de: 'Erledigt', en: 'Done' },
    'maintenance.closeReport': { de: 'St\u00f6rungsmeldung schliessen', en: 'Close problem report' },
    'maintenance.adminEyebrow': { de: 'Direkt an den Haus-Admin', en: 'Directly to the building admin' },
    'maintenance.reportIntro': { de: 'Beschreibe kurz, was nicht funktioniert. Der Haus-Admin entscheidet danach \u00fcber Sperre, Reparatur und Freigabe.', en: 'Briefly describe what is not working. The building admin then decides on blocking, repair and release.' },
    'maintenance.resourceLabel': { de: 'Ger\u00e4t oder Raum', en: 'Equipment or room' },
    'maintenance.shortTitle': { de: 'Kurzer Titel', en: 'Short title' },
    'maintenance.titlePlaceholder': { de: 'z.B. Wasser l\u00e4uft nicht ab', en: 'e.g. water is not draining' },
    'maintenance.observationLabel': { de: 'Was hast du beobachtet?', en: 'What did you observe?' },
    'maintenance.observationPlaceholder': { de: 'Bitte nur sachlich beschreiben, ohne Vermutungen.', en: 'Describe only what you observed, without assumptions.' },
    'maintenance.sendReport': { de: 'Meldung senden', en: 'Send report' },
    'maintenance.ownReportsTitle': { de: 'Meine Meldungen', en: 'My reports' },
    'maintenance.noOwnReports': { de: 'Du hast noch keine Stoerung gemeldet.', en: 'You have not reported a problem yet.' },
    'maintenance.resourceRemoved': { de: 'Nicht mehr vorhandene Ressource', en: 'Resource no longer available' },
    'maintenance.pushUpdates': { de: 'Push', en: 'Push' },
    'maintenance.emailUpdates': { de: 'E-Mail', en: 'Email' },
    'maintenance.saveUpdates': { de: 'Hinweise speichern', en: 'Save updates' },
    'maintenance.preferencesSaved': { de: 'Benachrichtigungen gespeichert.', en: 'Notification preferences saved.' },
    'maintenance.deletePersonalReport': { de: 'Persoenliche Meldung loeschen', en: 'Delete personal report' },
    'maintenance.deleteConfirm': { de: 'Persoenliche Meldungsdaten wirklich loeschen? Der neutrale Betriebsfall bleibt erhalten.', en: 'Delete your personal report data? The neutral operational case will remain.' },
    'maintenance.alreadyBlockedSuffix': { de: ' (bereits gesperrt)', en: ' (already blocked)' },
    'maintenance.pushUnavailable': { de: 'Fuer dieses Haus ist kein aktives Push-Geraet verfuegbar.', en: 'No active Push device is available for this building.' },
    'maintenance.pushUnavailableReportHouse': { de: 'Fuer das Haus dieser Meldung ist kein aktives Push-Geraet verfuegbar.', en: 'No active Push device is available for the building of this report.' },
    'maintenance.emailUnavailable': { de: 'Keine bestaetigte E-Mail-Adresse verfuegbar.', en: 'No confirmed email address is available.' },
    'maintenance.deliveryUnknown': { de: 'Zustellausgang unklar. Der In-App-Status bleibt massgebend.', en: 'Delivery outcome unknown. The in-app status remains authoritative.' },
    'maintenance.takeOver': { de: 'Bearbeitung uebernehmen', en: 'Start processing' },
    'maintenance.releaseAndClose': { de: 'Freigeben und abschliessen', en: 'Release and close' },
    'maintenance.closeCase': { de: 'Fall abschliessen', en: 'Close case' },
    'maintenance.noCasesInStatus': { de: 'Keine Meldungen in diesem Status.', en: 'No reports with this status.' },
    'maintenance.caseTitle': { de: 'Stoerungsfall', en: 'Issue case' },
    'maintenance.reportDetails': { de: 'Meldungen ({count})', en: 'Reports ({count})' },
    'maintenance.affectedBookings': { de: 'Kommende Buchungen ({count})', en: 'Upcoming bookings ({count})' },
    'maintenance.noAffectedBookings': { de: 'Keine kommenden Buchungen betroffen.', en: 'No upcoming bookings are affected.' },
    'maintenance.systemActor': { de: 'System', en: 'System' },
    'maintenance.blockDecision': { de: 'Was soll mit der Ressource passieren?', en: 'What should happen to the resource?' },
    'maintenance.blockResource': { de: 'Ressource sperren', en: 'Block resource' },
    'maintenance.keepAvailable': { de: 'Ressource nicht sperren', en: 'Keep resource available' },
    'maintenance.chooseBlockDecision': { de: 'Bitte ausdruecklich waehlen, ob die Ressource gesperrt wird.', en: 'Choose explicitly whether the resource should be blocked.' },
    'maintenance.notificationLegend': { de: 'Statusaenderungen erhalten (freiwillig)', en: 'Receive status updates (optional)' },
    'maintenance.pushStatusChanges': { de: 'Push bei In Bearbeitung und Erledigt', en: 'Push for In progress and Done' },
    'maintenance.emailStatusChanges': { de: 'E-Mail bei In Bearbeitung und Erledigt', en: 'Email for In progress and Done' },
    'maintenance.disclaimer': { de: 'Die Statusanzeige ist keine Zusage zu Bearbeitungsfrist, Haftung oder Kosten. WaschZeit ist kein Notfallkanal.', en: 'The status does not promise a response time, liability decision or costs. WaschZeit is not an emergency channel.' },
    'admin.selectedHouseContext': { de: 'Aktuell ausgewaehltes Haus', en: 'Currently selected building' },
    'admin.ownHouseContext': { de: 'Dein verwaltetes Haus', en: 'Your managed building' },
    'admin.houseView': { de: 'Haus', en: 'Building' },
    'admin.equipmentView': { de: 'Geraete', en: 'Equipment' },
    'admin.houseEquipmentChoice': { de: 'Haus oder Geraete anzeigen', en: 'Show building or equipment' },
    'admin.noDryingRoom': { de: 'Kein Trockenraum', en: 'No drying room' },
    'admin.noTumbler': { de: 'Kein Tumbler', en: 'No dryer' },
    'admin.dryingDurationSummary': { de: 'Trockenraum: {count} Zeitfenster', en: 'Drying room: {count} time slots' },
    'admin.fixedSaved': { de: 'Dauerpaket gespeichert.', en: 'Recurring package saved.' },
    'admin.fixedWasher': { de: 'Waschmaschine', en: 'Washing machine' },
    'admin.fixedDryingRoom': { de: 'Trockenraum (optional)', en: 'Drying room (optional)' },
    'admin.fixedDryingDuration': { de: 'Nutzungsdauer Trockenraum', en: 'Drying room duration' },
    'admin.fixedTumbler': { de: 'Tumbler (optional)', en: 'Dryer (optional)' },
    'admin.fixedApartment': { de: 'Wohnung (optional)', en: 'Apartment (optional)' },
    'admin.noFixedApartment': { de: 'Keine Wohnungszuordnung', en: 'No apartment assignment' },
    'admin.fixedApartmentSummary': { de: 'Wohnung: {apartment}', en: 'Apartment: {apartment}' },
    'admin.timeSlotOne': { de: '1 Zeitfenster', en: '1 time slot' },
    'admin.timeSlotTwo': { de: '2 Zeitfenster', en: '2 time slots' },
    'admin.timeSlotThree': { de: '3 Zeitfenster', en: '3 time slots' },
    'admin.logbookSearchPlaceholder': { de: 'Geraet, Meldung oder Haus', en: 'Equipment, report or building' },
  ...
  const englishPatterns = [
    ...
    [/^(.+) wurde ohne Ger(?:ae|\u00e4)te angelegt\.$/, '$1 was created without equipment.'],
